<?php if(!$sf_user->isAuthenticated()):?>
    ...
    <div class="sign_popup" style="display:none;">
            <?php if($form['username']->hasError()):?>
            <p class="error"> We don't seem to know you yet. <a href="<?php echo url_for('/customer/new') ?>">Sign Up</a> or try another username.</p>
            <?php endif; ?>
            <form action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
            <?php echo $form['_csrf_token']; ?>
            <strong>User name</strong>
            <?php echo $form['username']->render(array('class'=>"text error_text")); ?>
